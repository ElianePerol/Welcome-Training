...
// SQL statement to fetch the ongoing schedule for the teacher
...
$stmt_schedule->bindParam(':teacher_id', $teacher_id, PDO::PARAM_INT);  // Ensure it's an integer
$stmt_schedule->bindParam(':current_date', $current_date, PDO::PARAM_STR); // Ensure it's a string (date)
$stmt_schedule->execute();

// Fetches all the matches in the db, saves in an array
...
if ($schedules) {
    ...
    if ($current_schedule_id) {
        ...
        // Fetch all students for the ongoing class
